...
export function TrainingPackages() {
  return (
    <SectionShell
      ...
      description="Private training packages for athletes who want consistent reps. Youth camp weekly pricing is listed separately in the camp section."
      density="default"
      animateEnter
    ...
    >
      ...
      <ul className="relative z-[1] grid list-none gap-5 p-0 sm:grid-cols-3 sm:gap-6">
